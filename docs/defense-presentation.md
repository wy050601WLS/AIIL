...
| 时间 | 内容 | 页数 |
|------|------|------|
| 0-2 min | 项目概述（背景 + 技术栈 + 成果） | 1 页 |
| 2-5 min | SSE 流式对话 + Markdown 防抖 | 2 页 |
| 5-7 min | JWT 认证 + 无限滚动 | 2 页 |
| 7-9 min | AI 搜索 + 文档解析 | 2 页 |
| 9-10 min | 学习面板 + 性能优化 | 2 页 |
| 10-11 min | 安全防护 + 难点解决 | 2 页 |
| 11-12 min | 总结展望 | 1 页 |
| 12-20 min | 提问环节 | — |
